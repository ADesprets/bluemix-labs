...
| V3 | Resource Owner Password Credentials Grant | Resource owner - Password |xref:#_oauth_resource_owner_password_credentials_grant[here]
...
| V6 | Implicit grant | Implicit |xref:#_oauth_implicit_grant[here]
| V7 | External OAuth Provider | |xref:#_external_oauth_provider[here]
| V8 | Custom JWT Generate and Validate | |xref:#_custom_jwt_generate_and_validate[here]
