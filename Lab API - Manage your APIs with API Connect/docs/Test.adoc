...
The important parts that we will change in the lab is the base path, the description to indicate the security mechanism used, the security requirement and securty scheme.
