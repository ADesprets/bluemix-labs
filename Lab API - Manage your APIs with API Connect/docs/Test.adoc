...
image::../images/OAuth-native-baseinfo.png[Native OAuth provider creation base information]
...
image::../images/OAuth-native-grants.png[Native OAuth provider creation base information]

Click Next button

Specify the scopes you want to support, in our case we will use only one scope *details*. To provide detailed access.

image::../images/OAuth-native-scopes.png[Native OAuth provider creation scopes]
...
image::../images/OAuth-native-auth.png[Native OAuth provider creation processing]

Click Next button

You get a Summary screen.

image::../images/OAuth-native-summary.png[Native OAuth provider creation summary]
...
image::../images/native-edit-scopes.png[Native OAuth provider scopes configuration]

* In the Tokens panel, click on the Refresh tokens checkbox and click Save button

image::../images/native-edit-tokens.png[Native OAuth provider tokens configuration]
...
image::../images/native-edit-token-mgmt.png[Native OAuth provider token management configuration ]

* In the Introspection panel, click on the Introspection checkbox and then click on the Save button

image::../images/native-edit-introspection.png[Native OAuth provider introspection configuration]

* Look at the Metadata Panel, you will see other settings to collect metadata.

image::../images/native-edit-metadata.png[Native OAuth provider metadata configuration]

* In the OpenID Connect panel, click on the Enable OIDC checkbox and keep the other values, then click on the Save button.

image::../images/native-edit-oidc.png[Native OAuth provider OIDC configuration]
...
image::../images/native-edit-assembly.png[Native OAuth provider Assembly Panel]
...
image::../images/oauth-native-manager-associate.png[OAuth provider association to Catalog Edit]

Click on the checkbox close to the NativeProvider

image::../images/oauth-native-manager-associate-edit.png[OAuth provider association to Catalog]
...
image::../images/ropc-secure-API.png[OAuth Resource Owner Password Credentials API protection]
...
image::../images/ropc-secure-API-sec-def.png[OAuth Resource Owner Password Credentials API security Definition]

In the Security selection, select Native ROPC OAuth and the details scope.

image::../images/ropc-secure-API-sec.png[OAuth Resource Owner Password Credentials API security Definition]
...
image::../images/test-ropc-21.png[Test Get Access Token]
...
image::../images/test-ropc-22.png[Test Get Access Token]
...
image::../images/access-secure-API-sec-def.png[OAuth Access Code API protection Security Definition]

Click Save button.
In the Security section, select Native Authorization and the two scope details and openid, then click Save button.

image::../images/access-secure-API-sec.png[OAuth Access Code API protection Security]
...
image::../images/test-access-21.png[Test Using the Access Token]
