...
image::../images/V1005-policies.png[V10 Policies]
...
image::../images/designer-select-from-existingV1005.png[Designer Select from existing Open API] 
...
image::../images/designer-specify-quote-apiV1005.png[Designer Specify quote api]
...
image::../images/design-add-productV1005.png[Designer Add product]
...
image::../images/designer-new-product-infoV1005.png[Designer New product Information]

Select the Quote API by clicking on the check box and the click *Next* button.

image::../images/designer-new-product-selectapiV1005.png[Designer New product Select API]

Change or adjust the plan according to your requirements plan and then click on *Next* button.

image::../images/designer-new-product-planV1005.png[Designer New product Select plan]

Change or adjust the visibility or subscribability according to your requirements plan and then click on *Next* button.

image::../images/designer-new-product-visibilityV1005.png[Designer New product Select visibility]

click on *Edit Product* button.

image::../images/designer-new-product-doneV1005.png[Designer New product Done]
...
image::../images/designer-quote-product-publishV1005.png[Designer Quote product publish]

Then click on the *Publish* button.

image::../images/designer-quote-product-publish-doneV1005.png[Designer Quote product publish done]

We can check on the remote Manager that the Product containing the Quote API has been correctly published.

image::../images/designer-publish-product-remoteV1005.png[Designer Quote product publish remote]
